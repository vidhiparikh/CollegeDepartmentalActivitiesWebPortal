...
if(isset($_POST['insert-image'])){
	...
	if(isset($_POST['applicable']))
	{
		...
		{
			$query = "Update online_course_organised set attendence_path ='NULL'  where OC_O_ID = $cardId";
             mysqli_query($conn,$query);
			 $success =1;
			$file_name = $cardId. "_organised.jpg";
			$file = "/opt/lampp/htdocs/extc/Attendance/$file_name";
			if (!unlink($file)){
		...
		{
			$query = "Update online_course_organised set attendence_path ='not_applicable'  where OC_O_ID = $cardId";
             mysqli_query($conn,$query);
			 			 $success =1;
			$file_name = $cardId. "_organised.jpg";
			$file = "/opt/lampp/htdocs/extc/Attendance/$file_name";
		...
		else if($_POST['applicable'] == 1)
		{
			...
			$type = strtolower(end($name_parts));
			  $targetName="Attendance/".$_POST['id']."_organised.jpg";  
			  if(empty($errors)==true) {
				if (file_exists($targetName)) {   
				 ...
				 if($moved == true){
					 //successful
					 $query = "Update online_course_organised set attendence_path =' ".$targetName."'  where OC_O_ID = $cardId";
					 mysqli_query($conn,$query);
					 			 $success =1;
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Upload Attendance Record</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form action="" method="POST" enctype="multipart/form-data" class="row">
					...
					<div class='second-reveal'>
					 <div class="form-group col-md-6">
                         ...
                         <label for="card-image">Attendance Record * </label>
