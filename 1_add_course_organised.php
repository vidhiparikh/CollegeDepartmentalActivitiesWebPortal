                     ...
                     <div class="form-group col-md-6">
                      ...
                      <div class="sponsored-div">
                          <div class="form-group col-md-6">
                              ...
                              <input  type="text" class="form-control input-lg" id="sponsor" name="sponsor[]">
                          </div>
                          <div class="form-group col-md-6">
